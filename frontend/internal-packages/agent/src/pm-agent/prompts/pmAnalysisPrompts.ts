...
- The sql field must always be an empty string ("") - SQL will be generated by QA Agent.
- The testResults field must always be an empty array ([]).
...
- Each testcase must have:
  ...
  - sql: Always empty string ("") - will be filled by QA Agent
  - testResults: Always empty array ([])
