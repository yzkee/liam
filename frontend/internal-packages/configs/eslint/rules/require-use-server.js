/**
 * ESLint custom rule to enforce 'use server' directive in Server Actions files
 * @fileoverview Rule to ensure Server Actions files start with 'use server' directive
 */
