-- -----------------------------------------------------------------------------
-- Source:   https://github.com/supabase/splinter/blob/main/splinter.sql
-- License:  MIT (see upstream repository for full text)
-- Purpose:  Shared Splinter rule set used by @liam-hq/db lint workflow
-- -----------------------------------------------------------------------------
