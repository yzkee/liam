...
CREATE OR REPLACE FUNCTION "public"."add_project"("p_project_name" "text", "p_repository_name" "text", "p_repository_owner" "text", "p_installation_id" bigint, "p_repository_identifier" bigint, "p_organization_id" "uuid", "p_schema_file_path" "text", "p_schema_format" "public"."schema_format_enum") RETURNS "jsonb"
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
declare
...
ALTER FUNCTION "public"."add_project"("p_project_name" "text", "p_repository_name" "text", "p_repository_owner" "text", "p_installation_id" bigint, "p_repository_identifier" bigint, "p_organization_id" "uuid", "p_schema_file_path" "text", "p_schema_format" "public"."schema_format_enum") OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."add_project"("p_project_name" "text", "p_repository_name" "text", "p_repository_owner" "text", "p_installation_id" bigint, "p_repository_identifier" bigint, "p_organization_id" "uuid", "p_schema_file_path" "text", "p_schema_format" "public"."schema_format_enum") TO "authenticated";
GRANT ALL ON FUNCTION "public"."add_project"("p_project_name" "text", "p_repository_name" "text", "p_repository_owner" "text", "p_installation_id" bigint, "p_repository_identifier" bigint, "p_organization_id" "uuid", "p_schema_file_path" "text", "p_schema_format" "public"."schema_format_enum") TO "service_role";
