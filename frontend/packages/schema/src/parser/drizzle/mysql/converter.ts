...
const convertToTable = (
  ...
  // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: Complex logic for converting Drizzle table definitions to internal format (important-comment)
): Table => {
