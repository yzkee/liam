...
export const parseColumnFromProperty = (
  prop: Property,
  // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: Complex parsing logic for handling various PostgreSQL column types and options (important-comment)
